...
- (void)viewDidLoad
{
    ...
    /* View Controller on-the-fly 
     
    UIViewController *someViewController = [[UIViewController alloc] init];
    someViewController.view.frame = self.view.frame;
    someViewController.title = @"Some VC";
    
    UIImageView *someView = [[UIImageView alloc] initWithImage:[UIImage imageNamed:@""]];
    [someView setContentMode:UIViewContentModeScaleAspectFill];
    someView.frame = someViewController.view.frame;
    
    [someViewController.view addSubview:someView];
